                  ...
                  setState(() {
                    _searchResults =
                        _journals
                            .where(
                              (journal) =>
                                  journal['plotName'].toLowerCase().contains(
                                    value.toLowerCase(),
                                  ) ||
                                  journal['houseName'].toLowerCase().contains(
                                    value.toLowerCase(),
                                  ) ||
                                  journal['tenantName'].toLowerCase().contains(
                                    value.toLowerCase(),
                                  ),
                            )
                            .toList();
                                ...
                                child: ListTile(
                                  ...
                                  title: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        _searchResults[index]['houseName'],
                                        style: const TextStyle(
                                          color: Colors.white,
                                          fontSize: 14,
                                        ),
                                  ...
                                  trailing: Text(
                                    _searchResults[index]['tenantName'],
                                    style: const TextStyle(
                                      color: Colors.white,
                                      fontSize: 14,
                                    ),

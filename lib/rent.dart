      ...
      pageBuilder: (context, animation1, animation2) {
        return StatefulBuilder(
          builder: (context, setState) {
            // Parse selected months (comma-separated string to Set<int>)
            final selectedMonths = Set<int>.from(
              (tenant['selectedMonths'] as String?)
                      ?.split(',')
                  ...
                  itemBuilder: (context, monthIndex) {
                    ...
                    return GestureDetector(
                      onTap: () async {
                        ...
                        // Close the dialog before the async gap to avoid context issues
                        ...
                        await SQLHelper.updateItem(
                          ...
                          tenant['tenantName'],
                          tenant['phone'],
                          selectedMonths.join(','), // pass as string
                        );
